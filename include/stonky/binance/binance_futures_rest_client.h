...
#ifndef INCLUDE_STONKY_BINANCE_FUTURES_REST_CLIENT_H
#define INCLUDE_STONKY_BINANCE_FUTURES_REST_CLIENT_H
...
#endif //INCLUDE_STONKY_BINANCE_FUTURES_REST_CLIENT_H
